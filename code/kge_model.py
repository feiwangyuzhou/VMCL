...
class KGEModel(nn.Module):
    ...
    def forward(self, sample, ent_emb, ent_emb_last=None, mode='single'):
        '''
        ...
        if self.model_name in model_func:
            ...
            # score_transE = model_func['TransE'](head, relation, tail, mode)
            # score_rotatE = model_func['RotatE'](head, relation, tail, mode)
            # score = score_transE + score_rotatE*0.5
        else:
            raise ValueError('model %s not supported' % self.model_name)
